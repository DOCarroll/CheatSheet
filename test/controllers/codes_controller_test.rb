...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { content: @code.content, language: @code.language, title: @code.title }
    end
  ...
  test "should update code" do
    patch :update, id: @code, code: { content: @code.content, language: @code.language, title: @code.title }
    assert_redirected_to code_path(assigns(:code))
  end
